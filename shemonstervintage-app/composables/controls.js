...
onMounted(() => {
  ...
  grid.position.x =
    targetWidth * currendGrid * itemGapX * (currendGrid - 1) - targetWidth / 2; // center the grid
  grid.position.y = targetHeight / 2; // center the grid vertically
  ...
  Observer.create({
    ...
    onClick(ev) {
      ...
      // modal scaling
      const scaleX = (targetWidth / visibleW) * 2;
      const scaleY = targetHeight / visibleH;
